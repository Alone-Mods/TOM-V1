...
module.exports = {
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/k05oyeF.jpg' : process.env.GAN_IMAGE,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'TOM' : process.env.BOT_NAME,
    ...
    RASHI: process.env.LOGO_LINK === undefined ? 'https://i.imgur.com/k05oyeF.jpg' : process.env.LOGO_LINK,
    ...
    MAHN: process.env.MAAN === undefined ? '916235693746,0' : process.env.MAAN,
    BRANCH: 'master',
    HEROKU: {
