...
re codded by by Alone Credits Rashi
TOM V1
*/
const fs = require('fs')
...
const array = ['Zara','Bye','bye','Poli','Dance','Gd mrng','Ara','Poyi','myr','poda','podi','Pain','girl','asena','ayin','back','Back','Bot','fuck','Fuck','Hehe','Hello','Hlo','Kill','kill','kiss','line','love','mwolu','Mwolu','single','tha','thund','z','Z','bie','Bie','akash','alive','alone','andi','bot','cut','dp','ff','hi','hlo','melere','menu','no','rlfa','shaji','tag','tom','Tombot','hacker','arakkal','🐦']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
